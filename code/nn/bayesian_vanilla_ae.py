...
class BayesianVanillaAE(pl.LightningModule):
    """BayesianVanillaAE class"""
    def __init__(self, nn_save_dir, nn_params_dict, nn_train_params_dict, nn_datasets_dict):
        super(BayesianVanillaAE, self).__init__()
