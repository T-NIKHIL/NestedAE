...
labels = [r'$l_0$', r'$l_1$', r'$l_2$', r'$l_3$', r'$l_4$', r'$l_5$', r'$l_6$', 'BE']
...
plt.tight_layout()
plt.savefig('ae2_mhp_binding_energy_latents_and_target_corr_matrix_adj.pdf', format='pdf', dpi=300, bbox_inches='tight')