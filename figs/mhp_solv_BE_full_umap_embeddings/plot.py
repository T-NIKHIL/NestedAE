...
data = pd.read_csv('all_data_umap.csv')

dim1 = data['UMAP1'].values
dim2 = data['UMAP2'].values
true_be = data['True Binding Energy'].values
...
plt.tight_layout()
plt.savefig('mhp_bandgap_mhp_solv_BE_full_umap_embeddings.pdf', bbox_inches='tight', dpi=300)