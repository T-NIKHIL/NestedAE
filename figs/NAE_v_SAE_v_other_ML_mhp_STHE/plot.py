...
if __name__ == "__main__":
    ...
    if not plot:
        ...
        grid = GridSearchCV(estimator=NuSVR(),
                            param_grid=param_grid_nusvr,
        ...
        model_name =     ['XGBoost', 'RandomForest', 'NuSVR', 'Lasso', 'Ridge', 'SingleAE', 'NestedAE']
        mean_mae_test =  [ 0.035,    0.026,          0.004,   0.169,   0.168,   0.160,       0.110]
        std_mae_test =   [ 0.004,    0.004,          0.002,   0.009,   0.007,   0.030,       0.010]
        mean_mae_train = [ 0.002,    0.012,          0.002,   0.169,   0.166,   0.150,       0.120]
        std_mae_train =  [ 0.000,    0.001,          0.000,   0.001,   0.001,   0.030,       0.020]
        ...
        plt.savefig('NAE_v_SAE_v_other_ML_mhp_STHE.pdf', bbox_inches='tight', dpi=300)