...
if __name__ == "__main__":
    ...
    rename_columns = ['A_IONRAD',
                    ...
                    'B_En_mull',
                    'X_En_mull',
                    'x(S)',r't', r'o', r'tao', r'CBM', r'VBM', r'n_abs\(\%\)', r'n_cu\(\%\)']  # Set to None to keep original column names
    load_data = False
    data_filename = 'shapley_vals_for_sthe_pred_using_fold6_val.csv'
    ...
    if not load_data:
        ...
        if target_for_SHAP_calc == 'sthe':
            print(f'(INFO) Calculating SHAP values for STHE prediction')
            if features_for_SHAP_calc == 'descriptors':
                ...
                if which_dataset_to_use == 'val':
                    ...
                    explainer = Permutation(convert_to_tensor, val_dataset_df)
