...
labels = [r'$l_0$', r'$l_1$', r'$l_2$', r'$l_3$', r'$l_4$', r'$l_5$', r'$l_6$', r'$l_7$', r'$l_8$', r'$l_9$', r'$l_{10}$', r'$l_{11}$', 'bg', 'BE']
...
plt.tight_layout()
plt.savefig('hd_mhp_latents_and_target_corr_matrix_adj.pdf', format='pdf', dpi=300, bbox_inches='tight')