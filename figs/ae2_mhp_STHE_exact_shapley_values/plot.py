...
if __name__ == "__main__":
    ...
    rename_columns = [r't', r'o', r'tao', r'CBM', r'VBM', r'n_abs\(\%\)', r'n_cu\(\%\)', 'l0', 'l1', 'l2', 'l3', 'l4', 'l5', 'l6']  # Set to None to keep original column names
    load_data = True
    data_filename = 'shapley_vals_for_sthe_pred_using_fold2_val.csv'
